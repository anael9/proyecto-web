...
<center><button value="1" name="env" class="button"><span>Buscar</span></button></center>
 ...
 <!--tabla-->
      <div id="login" class="posicion">
        ...
        <h2><span class="fontawesome-lock"></span>Jornada</h2>
      ...
      <?php
include_once('jornadareportes.php');
...
?>  
        ...
        <form action="#" method="POST">
          <fieldset>
          <p><a href="jornadacatalogo.php"><input type="button" id="guardar1" name="guardar" value="nuevo"></p></a>
          </fieldset>
        </form>
