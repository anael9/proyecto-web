...
<td><center>
<a href=futposi.php?id_us=".$fila[0]."><img src=http://ventadeactivos.com/img/ico2.png width=35 height=35 /></a><a href=actualiza.php?borrar=".$fila[0]."><img src=imagenes/borrar.jpg width=35 height=35 />
</center></td>";
echo "</tr>";  
}
echo "</table>";
