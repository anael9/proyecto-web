...
if(isset($_POST["id"])){
$actualizado=new  actualigoles($_POST["id"],$_POST["Equipo"],$_POST["Jugador"],$_POST["Juego"], $_POST["Minuto"], $_POST["idjugador"], $_POST["idequipo"]);
$actualizado->actualiza();
}

elseif (isset($_POST["ids"])){
$actualizado=new  actualigoles($_POST["ids"],$_POST["Equipo"],$_POST["Jugador"],$_POST["Juego"], $_POST["Minuto"], $_POST["idjugador"], $_POST["idequipo"]);
$actualizado->guardar();
}

elseif(isset($_GET["borrar"])){
$actualizado=new  actualigoles($_GET["borrar"],0,0,0,0,0,0);
